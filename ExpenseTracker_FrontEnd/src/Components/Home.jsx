          ...
          <tr>
              ...
              <tbody>
              {
                ...
                <tr>
                  ...
                  <td>
                    <Link to={'updateExpense/'+ expenses.expenseId} className="btn btn-sm btn-primary">Edit </Link>
                   
                    <button onClick={()=>deleteUserExpense(expenses.expenseId)} className="btn btn-sm btn-danger ms-3">Delete</button>
                  </td>
                </tr>
             ) )}
              </tbody>
