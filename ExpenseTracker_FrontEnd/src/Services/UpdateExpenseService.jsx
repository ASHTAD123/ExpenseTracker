...
const API_UPDATE_EXPENSE_URL = import.meta.env.PROD ? `${import.meta.env.VITE_API_URL}/expenseTracker/updateExpense` :"http://localhost:8080/expenseTracker/updateExpense/";
