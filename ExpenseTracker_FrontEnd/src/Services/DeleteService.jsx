...
const API_DELETE_EXPENSES_URL = import.meta.env.PROD ? `${import.meta.env.VITE_API_URL}/expenseTracker/removeExpense`: "http://localhost:8080/expenseTracker/removeExpense/";
